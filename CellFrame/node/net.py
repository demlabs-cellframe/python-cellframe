...
from .items import CFTxOutCond
from .config import CFConfig
from .exceptions import InsufficientFundsError
from ..common.types import ChainTypes, DatumTypes, ItemTypes, ItemTypesValues
...
class CFLedger:
    ...
    Attributes:
        net (CFNet): The CFNet object.
        _origin_ledger (Ledger): The original Ledger object.
    """
    ...
    def __init__(self, net: CFNet, ledger: Ledger = None):
        ...
        Args:
            net (CFNet): The CFNet object.
            ledger (Ledger, optional): The Ledger object. Defaults to None.
        """
        self.net = net
