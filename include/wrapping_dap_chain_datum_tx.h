...
static PyMethodDef PyDapChainTxItemTypeObjectMethods[] ={
    ...
    {"TX_ITEM_TYPE_SIG_PY", (PyCFunction)TX_ITEM_TYPE_SIG_PY, METH_NOARGS | METH_STATIC, ""},
    ...
    {"TX_ITEM_TYPE_OUT_SERVICE_RECEIPT_PY", (PyCFunction)TX_ITEM_TYPE_OUT_SERVICE_RECEIPT_PY,
