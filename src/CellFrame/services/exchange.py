...
try:
    ...
    # Centralized check for all required exchange functions - ONCE at import
    required_functions = [
    ...
    raise ImportError(
        "❌ CRITICAL: Native CellFrame exchange functions not available!\n"
        ...
        f"Original error: {e}\n"
        "Please implement exchange bindings in src/cellframe_services.c"
    ) from e
