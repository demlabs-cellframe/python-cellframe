...
int cellframe_type_init(PyObject *module) {
    static PyMethodDef type_methods[] = {
        ...
        {"dap_chain_block_new", dap_chain_block_new_py, METH_VARARGS, "Create new block"},
        {"dap_chain_block_get_size", dap_chain_block_get_size_py, METH_VARARGS, "Get block size"},
        {"dap_chain_block_meta_add", dap_chain_block_meta_add_py, METH_VARARGS, "Add block metadata"},
        ...
        {"dap_chain_block_datum_add", dap_chain_block_datum_add_py, METH_VARARGS, "Add datum to block"},
        {"dap_chain_block_datum_del_by_hash", dap_chain_block_datum_del_by_hash_py, METH_VARARGS, "Delete datum from block by hash"},
        {"dap_chain_block_get_datums", dap_chain_block_get_datums_py, METH_VARARGS, "Get block datums"},
        {"dap_chain_block_sign_add", dap_chain_block_sign_add_py, METH_VARARGS, "Add block sign"},
