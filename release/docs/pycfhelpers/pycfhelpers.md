...
### *class* pycfhelpers.cellframenet.TSD ^TSD
...
### *class* pycfhelpers.cellframenet.CellframeEmission(datum: CellFrame.Common.DatumEmission, event: CellFrame.Consensus.DAG | None = None) ^CellframeEmission
...
### *class* pycfhelpers.cellframenet.CellframeBaseTransactionDatum(datum, net, block=None) ^CellframeBaseTransactionDatum
...
* **Returns:** The emission, if present,
  : otherwise None.
* **Return type:** *([[#^CellframeEmission|CellframeEmission]] | None, optional)*

### *class* pycfhelpers.cellframenet.CellframeNetwork(name, chains, group_alias=None, commision_wallet=None) ^CellframeNetwork
...
* **Parameters:**
  * **emission** ([[#^CellframeEmission|CellframeEmission]]) – The emission associated with
    the transaction.
...
* **Return type:** *Dict[str, [[#^CellframeEmission|CellframeEmission]]]*
...
* **Return type:** *List\[[[#^CellframeBaseTransactionDatum|CellframeBaseTransactionDatum]]]*
...
* **Return type:** *[[#^CellframeEmission|CellframeEmission]]*
...
### *class* pycfhelpers.globaldb.GDBTable(table) ^GDBTable
...
### *class* pycfhelpers.helpers.ListCache(capacity) ^ListCache
