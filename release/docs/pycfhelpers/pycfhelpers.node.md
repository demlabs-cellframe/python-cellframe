...
The original ChainAddr object
representing the wallet address.

* **Type:** *ChainAddr*

\_\_init_\_(address: str)

Initialize a CFWalletAddress object with the given address.
...
* **Returns:** The network ID of the wallet address.
...
The callback function to be executed when
...
* **Parameters:**
  ...
  * **callback** ([*CliCallback*](#pycfhelpers.node.cli.CliCallback)) – The callback function to be executed
    when the command is invoked.
  * **help_text** (*str* *,* *optional*) – The help text for the command.
    Defaults to “”.
...
Initialize a ReplyObject object with the given reply ID.
...
A list of CFSign objects representing
...
Initialize a CFBlock object with the given atom and chain.
...
* **Returns:** A list of CFDatum objects associated with the event.
* **Return type:** *list[[CFDatum](#pycfhelpers.node.datums.CFDatum)]*
...
* **Type:** *[CFKey](#pycfhelpers.node.crypto.CFKey) | None*
...
The hash of the public key associated
with the signature.
...
* **Returns:** Union[CFDatumTX, CFDatumToken, CFDatumEmission,
  : > CFDatumAnchor, CFDatumDecree, CFDatumCustom]:
    <br/>
...
List of cryptographic signatures associated
with the anchor.
...
* **Parameters:**
  * **parent_datum** ([*CFDatum*](#pycfhelpers.node.datums.CFDatum) *|* *None*) – The parent datum associated with
    the sub-datum, or None if there’s no parent datum.
...
The raw data associated with the custom sub-datum,
...
emission, including cryptographic signatures or dictionary data.

* **Type:** *list[Union[[CFSign](#pycfhelpers.node.crypto.CFSign), dict]]*

##### tsd

Typed section data associated with
the emission.
...
* **Parameters:**
  **certificate** ([*CFCertificate*](#pycfhelpers.node.crypto.CFCertificate)) – The certificate containing
  the signature.
...
* **Parameters:**
  * **parent_datum** ([*CFDatum*](#pycfhelpers.node.datums.CFDatum) *|* *None*) – The parent datum associated with the
    sub-datum, or None if there’s no parent datum.
...
* **Parameters:**
  **filter_type** (*type* *[**T* *]*  *|* *None* *,* *optional*) – The type to filter
  the items. Defaults to None.
...
* **Parameters:**
  * **parent_datum** ([*CFDatum*](#pycfhelpers.node.datums.CFDatum) *|* *None*) – The parent datum associated
    with the sub-datum, or None if there’s no parent datum.
  * **(****Union****[****DatumTx** (*sub_datum*) – DatumDecree, DatumAnchor, bytes]):
  * **DatumToken** – DatumDecree, DatumAnchor, bytes]):
  * **DatumEmission** – DatumDecree, DatumAnchor, bytes]):

:param : DatumDecree, DatumAnchor, bytes]):
:param The sub-datum object or its bytes representation.:
:param net: The CFNet instance representing
...
* **Parameters:**
  ...
  * **default** (*D* *,* *optional*) – The default value to return if
...
Return an iterator over CFBlock or CFEvent objects.

* **Yields:**
  *Iterator[Union[CFBlock, CFEvent]]* –

  An iterator over CFBlock or
  : CFEvent objects.
* **Raises:**
  **TypeError** – If Chain type neither ChainTypes.esbocs nor
      ChainTypes.dag_poa
...
Return an iterator over CFDatum objects.
...
* **Return type:** *Iterator[[CFDatum](#pycfhelpers.node.datums.CFDatum)]*

##### get_mempool()

Return the CFMempool object.
* **Returns:** The CFMempool object.
* **Return type:** *[CFMempool](#pycfhelpers.node.net.CFMempool)*

##### get_transactions()

Return an iterator over CFDatumTX objects.
* **Yields:**
...
Register the atom notification callback.
...
Register the mempool notification callback.
...
* **Return type:** *Union[ledger_cache_rc, None]*
...
* **Return type:** *Union[[CFDatum](#pycfhelpers.node.datums.CFDatum), None]*
...
* **Parameters:**
  **datum** (*Union* *[*[*CFDatum*](#pycfhelpers.node.datums.CFDatum) *,* [*CFSubDatum*](#pycfhelpers.node.datums.CFSubDatum) *]*) – The CFDatum or
  CFSubDatum object.
...
* **Parameters:**
  ...
  * **chain_name** (*Literal* *[* *"main"* *,*  *"zerochain"* *,*  *"all"* *]*) – The chain name to
    register the callback. Defaults to “all”.
...
* **Parameters:**
  * **\*args** – Positional arguments.
  * **chain_name** (*Literal* *[* *"main"* *,*  *"zerochain"* *,*  *"all"* *]*) – The chain name
    to register the callback. Defaults to “all”.
  * **\*\*kwargs** – Keyword arguments.
* **Returns:**
