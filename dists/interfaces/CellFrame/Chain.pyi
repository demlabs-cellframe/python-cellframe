...
class Mempool(Protocol):
    ...
    @staticmethod
    def datumExtract(datum_bytes: bytes) -> str | None:
        pass

    @staticmethod
    def datumGet(chain: Chain, bytes_obj: bytes) -> Datum:
        pass
...
class Ledger(Protocol):
    ...
    def bridgedTxNotifyAdd(self, *args):
        pass
    def txGetMainTickerAndLedgerRc(self,  datum_tx: DatumTx) -> tuple[str, str]: 
        pass