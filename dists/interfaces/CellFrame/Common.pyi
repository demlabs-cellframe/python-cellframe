...
# DapChainTxEventObjectType
class TxEvent(Protocol):
    @property
    def type(self) -> int: ...
    @property
    ...
    @property
    def srv_uid(self) -> int: ...
    @staticmethod
    def STAKE_EXT_STARTED() -> int: ...
    @staticmethod
    def STAKE_EXT_BID_PLACED() -> int: ...
    @staticmethod
    def STAKE_EXT_ENDED() -> int: ...
    @staticmethod
    def STAKE_EXT_CANCELLED() -> int: ...


# DapChainTxInRewardObjectType
class TxInReward(Protocol):
    @property
    def blockHash(self) -> HashFast: ...
