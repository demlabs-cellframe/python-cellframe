...
class GDBGroupJson(GDBGroup):
    """Represent a group that srores Json-serialized data as values.
    ...
    def set(self, key, value: dict | list):
        ...
        Args:
            key (str): table key
            value (dict|list): possible value to set

        """
        # Dump dict/list as a byte-encoded string and write at to a gdb-group
